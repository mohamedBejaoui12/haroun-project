...
if(isset($_POST['search'])){
    $search = $_POST['search'];
    $sql = "SELECT * FROM products WHERE name LIKE :search ORDER BY date DESC LIMIT :limit OFFSET :offset";
            ...
            <nav class="navbar bg-body-tertiary">
                <form class="container-fluid" method="POST">
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" placeholder="Search" aria-label="Search" aria-describedby="basic-addon1" name="search">
                    </div>
                </form>
            </nav>
        </div>
